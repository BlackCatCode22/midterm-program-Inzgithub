...
# Open the input file
my_file = open("C:/2023spring/pythonRoot/midtermFiles/animalNames.txt", "r", encoding="utf-8")
...
my_file = open("C:/2023spring/pythonRoot/midtermFiles/arrivingAnimals.txt", "r", encoding="utf-8")
...
for element in my_array:
    ...
    my_file = open("C:/2023spring/pythonRoot/midtermFiles/midTermOutputPython.txt", "w", encoding="utf-8")
